...
class ConversationalMemoryGraph:
    ...
    def add_utterance(self, session_id: str, text: str, emotion_scores: dict[str, float] | None = None) -> int:
        """
        ...
        for n, data in self.graph.nodes(data=True):
            if data.get("session_id") == session_id and n != node_id and data.get("timestamp", "") > last_time:
